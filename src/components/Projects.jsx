              ...
              <div className="h-full min-h-[500px] backdrop-blur-lg bg-white/5 border border-white/10 rounded-3xl p-10 flex flex-col transition-all duration-300 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20">
                ...
                <div className="flex gap-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="flex-1 text-center py-3 px-4 rounded-xl font-semibold text-white border-2 border-purple-500/50 transition-all duration-300 hover:bg-purple-500/10 hover:scale-105 hover:border-purple-500"
                  >
                    💻 Code
                  </a>
                </div>
